...
public class DrawView extends View {
	...
	public void onDraw(Canvas canvas) {
		...
		//Se dibujan dos rectángulos que son los contenedores de los arcos.
		RectF Containeroval = new RectF(100, 250, 295, 320);
		RectF ContainerOvalDos= new RectF(100,375,295,420);

		//Se trazan los medios arcos para poder hacer los medios círculos que
		//unen a cada círculo
       ...
       canvas.drawTextOnPath("Laura Moreno", trazo, 150, 40, paint);
